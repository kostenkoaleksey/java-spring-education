...
public class FacultyController {
    ...
    public List<FacultyDto> list(@PageableDefault(sort = "id") Pageable pageable) {
    ...
    public List<StudentDto> listFacultyStudents(@PathVariable Long facultyId, @PageableDefault(sort = "id") Pageable pageable) {
